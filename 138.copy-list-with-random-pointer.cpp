 ...
 *
 * [138] node List with Random Pointer
 *
 * https://leetcode.com/problems/node-list-with-random-pointer/description/
 *
 * algorithms
 * Medium (60.00%)
 * Likes:    14663
 ...
 * null.
 * 
 * Construct a deep node of the list. The deep node should consist of exactly n
